...
void run_context_tests(void) {
    ...
    CHECK(secp256k1_qd_ec_pubkey_create(sign, &pubkey, ctmp) == 1);
...
void run_eckey_edge_case_test(void) {
    ...
    VG_UNDEF(&pubkey, sizeof(pubkey));
    CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey, orderc) == 0);
    VG_CHECK(&pubkey, sizeof(pubkey));
    ...
    VG_UNDEF(&pubkey, sizeof(pubkey));
    CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey, ctmp) == 0);
    VG_CHECK(&pubkey, sizeof(pubkey));
    CHECK(memcmp(&pubkey, zeros, sizeof(secp256k1_pubkey)) == 0);
    ...
    memset(&pubkey, 0, sizeof(pubkey));
    VG_UNDEF(&pubkey, sizeof(pubkey));
    CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey, ctmp) == 1);
    VG_CHECK(&pubkey, sizeof(pubkey));
    CHECK(memcmp(&pubkey, zeros, sizeof(secp256k1_pubkey)) > 0);
    pubkey_one = pubkey;
    ...
    CHECK(secp256k1_ec_pubkey_tweak_add(ctx, &pubkey, ctmp2) == 1);
    ctmp2[31] = 1;
    CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey2, ctmp2) == 1);
    CHECK(memcmp(&pubkey, &pubkey2, sizeof(pubkey)) == 0);
    /* Tweak mul * 2 = 1+1. */
    CHECK(secp256k1_ec_pubkey_tweak_add(ctx, &pubkey, ctmp2) == 1);
    ctmp2[31] = 2;
...
void test_ecdsa_end_to_end(void) {
    ...
    CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey, privkey) == 1);
    ...
    if (secp256k1_rand_int(3) == 0) {
        ...
        CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey2, privkey) == 1);
        CHECK(memcmp(&pubkey, &pubkey2, sizeof(pubkey)) == 0);
    }
...
void test_ecdsa_edge_cases(void) {
    ...
    /* Signature where s would be zero. */
    {
        ...
        CHECK(secp256k1_qd_ec_pubkey_create(ctx, &pubkey, key) == 1);
